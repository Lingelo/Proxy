...
export function validateConfiguration(config: any): ValidationResult {
    ...
    validator
        .validateRequired('TARGET_URLS', process.env.TARGET_URLS, 'TARGET_URLS environment variable is required')
        ...
        .validateEnum('LOG_LEVEL', config.logLevel, ['error', 'warn', 'info', 'http', 'verbose', 'debug', 'silly']);
